...
**Path pattern**: `data/bronze/elexon/indgen/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/elexon/indgen/year=YYYY/month=MM/indgen_YYYYMMDD.parquet`
...
- **Forecast revision behaviour** — multiple publishes per period.
