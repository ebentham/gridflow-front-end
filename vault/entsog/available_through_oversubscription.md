...
Capacity made available through oversubscription mechanism (CMP).
...
**Path pattern**: `data/bronze/entsog/available_through_oversubscription/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/available_through_oversubscription/year=YYYY/month=MM/available_through_oversubscription_YYYYMMDD.parquet`
