---
source: entsog
dataset_key: allocations
vendor: ENTSOG Transparency Platform
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# ENTSOG — Allocations (`indicator=Allocation`)
...
|-----------|------|----------|-------------|---------|
| `indicator` | str | Yes | Exact-case indicator name | `Allocation` |
...
curl --ssl-no-revoke -fsS \
  ...
  "https://transparency.entsog.eu/api/v1/operationalData?from=2026-05-06&to=2026-05-06&timeZone=UCT&indicator=Allocation&periodType=day&pointDirection=UK-TSO-0001ITP-00005exit&forceDownload=true&limit=1000"
```
...
**Path pattern**: `data/bronze/entsog/allocations/<year>/<month>/<day>/raw_<uuid>.json`
...
```json
{
  ...
  "operationalData": [
    {
      "id": "1AllocationdayUK-TSO-0001ITP-00005exitkWh/d2026-01-012027-01-01_NA0",
      "dataSet": 1,
      ...
      "directionKey": "exit",
      "unit": "kWh/d",
      "itemRemarks": "Commercial Flows only available at Entry points in the GB regime",
      "generalRemarks": "",
      "value": "",
...
**Path pattern**: `data/silver/entsog/allocations/year=YYYY/month=MM/allocations_YYYYMMDD.parquet`
