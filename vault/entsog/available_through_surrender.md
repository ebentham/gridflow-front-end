...
**Path pattern**: `data/bronze/entsog/available_through_surrender/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/available_through_surrender/year=YYYY/month=MM/available_through_surrender_YYYYMMDD.parquet`
