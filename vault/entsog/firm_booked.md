...
**Path pattern**: `data/bronze/entsog/firm_booked/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/firm_booked/year=YYYY/month=MM/firm_booked_YYYYMMDD.parquet`
