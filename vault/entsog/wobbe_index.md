...
**Path pattern**: `data/bronze/entsog/wobbe_index/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/wobbe_index/year=YYYY/month=MM/wobbe_index_YYYYMMDD.parquet`
