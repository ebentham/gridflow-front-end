...
**Path pattern**: `data/bronze/entsog/firm_technical/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/firm_technical/year=YYYY/month=MM/firm_technical_YYYYMMDD.parquet`
