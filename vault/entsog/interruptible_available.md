...
**Path pattern**: `data/bronze/entsog/interruptible_available/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/interruptible_available/year=YYYY/month=MM/interruptible_available_YYYYMMDD.parquet`
