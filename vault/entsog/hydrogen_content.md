...
**Path pattern**: `data/bronze/entsog/hydrogen_content/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/hydrogen_content/year=YYYY/month=MM/hydrogen_content_YYYYMMDD.parquet`
