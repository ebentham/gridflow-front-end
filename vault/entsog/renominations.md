...
**Path pattern**: `data/bronze/entsog/renominations/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/renominations/year=YYYY/month=MM/renominations_YYYYMMDD.parquet`
