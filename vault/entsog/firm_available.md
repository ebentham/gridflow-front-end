...
Firm capacity remaining available for booking (offered to market, not yet booked).
...
**Path pattern**: `data/bronze/entsog/firm_available/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/firm_available/year=YYYY/month=MM/firm_available_YYYYMMDD.parquet`
