...
**Path pattern**: `data/bronze/entsog/interruptible_total/<year>/<month>/<day>/raw_<uuid>.json`
...
**Path pattern**: `data/silver/entsog/interruptible_total/year=YYYY/month=MM/interruptible_total_YYYYMMDD.parquet`
