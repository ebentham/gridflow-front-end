...
**Path pattern**: `data/bronze/neso/regional_scotland/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/regional_scotland/year=<YYYY>/month=<MM>/regional_scotland_<YYYYMMDD>.parquet`
