...
**Path pattern**: `data/bronze/neso/regional_intensity_fw48h_regionid/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/regional_intensity_fw48h_regionid/year=<YYYY>/month=<MM>/regional_intensity_fw48h_regionid_<YYYYMMDD>.parquet`
