...
**Path pattern**: `data/bronze/neso/intensity_period/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/intensity_period/year=<YYYY>/month=<MM>/intensity_period_<YYYYMMDD>.parquet`
