...
**Path pattern**: `data/bronze/neso/regional_wales/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/regional_wales/year=<YYYY>/month=<MM>/regional_wales_<YYYYMMDD>.parquet`
