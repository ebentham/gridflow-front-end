...
**Path pattern**: `data/bronze/neso/regional_intensity/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/regional_intensity/year=<YYYY>/month=<MM>/regional_intensity_<YYYYMMDD>.parquet`
