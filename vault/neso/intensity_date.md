...
**Path pattern**: `data/bronze/neso/intensity_date/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/intensity_date/year=<YYYY>/month=<MM>/intensity_date_<YYYYMMDD>.parquet`
