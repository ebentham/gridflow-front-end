...
**Path pattern**: `data/bronze/neso/regional_intensity_pt24h_postcode/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/regional_intensity_pt24h_postcode/year=<YYYY>/month=<MM>/regional_intensity_pt24h_postcode_<YYYYMMDD>.parquet`
