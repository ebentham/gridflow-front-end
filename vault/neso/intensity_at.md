...
**Path pattern**: `data/bronze/neso/intensity_at/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/intensity_at/year=<YYYY>/month=<MM>/intensity_at_<YYYYMMDD>.parquet`
