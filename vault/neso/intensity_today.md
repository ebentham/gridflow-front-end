---
source: neso
dataset_key: intensity_today
vendor: National Energy System Operator (NESO)
last_verified: 2026-05-08
layer_coverage: bronze, silver
---

# NESO - Today national carbon intensity (`intensity_today`)
...
**Path pattern**: `data/bronze/neso/intensity_today/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/intensity_today/year=<YYYY>/month=<MM>/intensity_today_<YYYYMMDD>.parquet`
