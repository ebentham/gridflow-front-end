...
**Path pattern**: `data/bronze/neso/intensity_pt24h/<year>/<month>/<day>/raw_<timestamp>_<hash>.json`
...
**Path pattern**: `data/silver/neso/intensity_pt24h/year=<YYYY>/month=<MM>/intensity_pt24h_<YYYYMMDD>.parquet`
