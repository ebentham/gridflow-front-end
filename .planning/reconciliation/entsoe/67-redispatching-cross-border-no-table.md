...
verifier_finding_id: vault-curl-schema-validation.md L216
references:
  - vault-curl-schema-validation.md L216
tags: [drift]
---

# ENTSO-E · redispatching_cross_border: No silver schema table in Vault markdown

## Context

The verifier reports `no_silver_schema_table` for `entsoe\datasets\redispatching_cross_border.md`. Schema section present but table absent.
