...
verifier_finding_id: vault-curl-schema-validation.md L289-290
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L289-290
tags: [drift]
---

# GIE · about_listing: No importable Pydantic schema (`manual_transformer_schema`)
