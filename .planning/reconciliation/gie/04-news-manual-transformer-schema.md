...
verifier_finding_id: vault-curl-schema-validation.md L295-296
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L295-296
tags: [drift]
---

# GIE · news: No importable Pydantic schema (`manual_transformer_schema`)
