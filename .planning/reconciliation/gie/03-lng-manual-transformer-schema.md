...
verifier_finding_id: vault-curl-schema-validation.md L293-294
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L293-294
tags: [drift]
---

# GIE · lng: No importable Pydantic schema (`manual_transformer_schema`)
