...
verifier_finding_id: vault-curl-schema-validation.md L299-300
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L299-300
tags: [drift]
---

# GIE · unavailability: No importable Pydantic schema (`manual_transformer_schema`)
