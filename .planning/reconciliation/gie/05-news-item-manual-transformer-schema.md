...
verifier_finding_id: vault-curl-schema-validation.md L297-298
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L297-298
tags: [drift]
---

# GIE · news_item: No importable Pydantic schema (`manual_transformer_schema`)
