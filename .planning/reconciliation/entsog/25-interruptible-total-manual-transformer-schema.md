...
verifier_finding_id: vault-curl-schema-validation.md L264-265
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L264-265
tags: [drift]
---

# ENTSO-G · interruptible_total: No importable Pydantic schema (`manual_transformer_schema`)
