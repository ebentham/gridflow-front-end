...
verifier_finding_id: vault-curl-schema-validation.md L268-269
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L268-269
tags: [drift]
---

# ENTSO-G · nominations: No importable Pydantic schema (`manual_transformer_schema`)
