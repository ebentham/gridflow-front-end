...
verifier_finding_id: vault-curl-schema-validation.md L258-259
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L258-259
tags: [drift]
---

# ENTSO-G · interconnections: No importable Pydantic schema (`manual_transformer_schema`)
