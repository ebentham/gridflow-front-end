...
verifier_finding_id: vault-curl-schema-validation.md L253-254
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L253-254
tags: [drift]
---

# ENTSO-G · firm_technical: No importable Pydantic schema (`manual_transformer_schema`)
