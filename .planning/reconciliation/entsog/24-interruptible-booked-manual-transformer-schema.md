...
verifier_finding_id: vault-curl-schema-validation.md L262-263
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L262-263
tags: [drift]
---

# ENTSO-G · interruptible_booked: No importable Pydantic schema (`manual_transformer_schema`)
