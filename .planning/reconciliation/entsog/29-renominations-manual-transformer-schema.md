...
verifier_finding_id: vault-curl-schema-validation.md L279-280
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L279-280
tags: [drift]
---

# ENTSO-G · renominations: No importable Pydantic schema (`manual_transformer_schema`)
