...
verifier_finding_id: vault-curl-schema-validation.md L251-252
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L251-252
tags: [drift]
---

# ENTSO-G · firm_booked: No importable Pydantic schema (`manual_transformer_schema`)
