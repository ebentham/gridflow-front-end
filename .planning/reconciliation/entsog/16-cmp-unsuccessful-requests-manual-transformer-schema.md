...
created: 2026-05-19
vendor: entsog
dataset: cmp_unsuccessful_requests
drift_category: Referential
verifier_finding_id: vault-curl-schema-validation.md L245-246
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L245-246
tags: [drift]
---

# ENTSO-G · cmp_unsuccessful_requests: No importable Pydantic schema (`manual_transformer_schema`)
