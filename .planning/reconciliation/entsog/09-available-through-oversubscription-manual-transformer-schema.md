...
verifier_finding_id: vault-curl-schema-validation.md L231-232
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L231-232
tags: [drift]
---

# ENTSO-G · available_through_oversubscription: No importable Pydantic schema (`manual_transformer_schema`)
