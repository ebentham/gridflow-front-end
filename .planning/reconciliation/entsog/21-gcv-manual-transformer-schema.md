...
verifier_finding_id: vault-curl-schema-validation.md L255-256
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L255-256
tags: [drift]
---

# ENTSO-G · gcv: No importable Pydantic schema (`manual_transformer_schema`)
