...
verifier_finding_id: vault-curl-schema-validation.md L239-240
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L239-240
tags: [drift]
---

# ENTSO-G · balancing_zones: No importable Pydantic schema (`manual_transformer_schema`)
