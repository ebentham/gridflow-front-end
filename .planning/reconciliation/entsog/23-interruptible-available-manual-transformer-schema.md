...
verifier_finding_id: vault-curl-schema-validation.md L260-261
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L260-261
tags: [drift]
---

# ENTSO-G · interruptible_available: No importable Pydantic schema (`manual_transformer_schema`)
