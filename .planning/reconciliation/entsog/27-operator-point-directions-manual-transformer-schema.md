...
verifier_finding_id: vault-curl-schema-validation.md L270-271
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L270-271
tags: [drift]
---

# ENTSO-G · operator_point_directions: No importable Pydantic schema (`manual_transformer_schema`)
