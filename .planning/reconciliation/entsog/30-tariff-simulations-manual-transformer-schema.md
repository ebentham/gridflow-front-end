...
verifier_finding_id: vault-curl-schema-validation.md L281-282
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L281-282
tags: [drift]
---

# ENTSO-G · tariff_simulations: No importable Pydantic schema (`manual_transformer_schema`)
