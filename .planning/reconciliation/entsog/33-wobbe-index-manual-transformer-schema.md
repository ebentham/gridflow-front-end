...
verifier_finding_id: vault-curl-schema-validation.md L287-288
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L287-288
tags: [drift]
---

# ENTSO-G · wobbe_index: No importable Pydantic schema (`manual_transformer_schema`)
