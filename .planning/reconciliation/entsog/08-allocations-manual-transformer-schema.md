...
verifier_finding_id: vault-curl-schema-validation.md L229-230
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L229-230
tags: [drift]
---

# ENTSO-G · allocations: No importable Pydantic schema (`manual_transformer_schema`)
