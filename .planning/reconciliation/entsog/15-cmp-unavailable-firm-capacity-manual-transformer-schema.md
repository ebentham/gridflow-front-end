...
created: 2026-05-19
vendor: entsog
dataset: cmp_unavailable_firm_capacity
drift_category: Referential
verifier_finding_id: vault-curl-schema-validation.md L243-244
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L243-244
tags: [drift]
---

# ENTSO-G · cmp_unavailable_firm_capacity: No importable Pydantic schema (`manual_transformer_schema`)
