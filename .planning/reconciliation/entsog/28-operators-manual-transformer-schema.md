...
verifier_finding_id: vault-curl-schema-validation.md L272-273
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L272-273
tags: [drift]
---

# ENTSO-G · operators: No importable Pydantic schema (`manual_transformer_schema`)
