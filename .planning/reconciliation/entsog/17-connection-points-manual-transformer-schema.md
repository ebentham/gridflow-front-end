...
verifier_finding_id: vault-curl-schema-validation.md L247-248
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L247-248
tags: [drift]
---

# ENTSO-G · connection_points: No importable Pydantic schema (`manual_transformer_schema`)
