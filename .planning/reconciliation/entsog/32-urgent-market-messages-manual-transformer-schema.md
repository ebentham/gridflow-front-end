...
created: 2026-05-19
vendor: entsog
dataset: urgent_market_messages
drift_category: Referential
verifier_finding_id: vault-curl-schema-validation.md L285-286
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L285-286
tags: [drift]
---

# ENTSO-G · urgent_market_messages: No importable Pydantic schema (`manual_transformer_schema`)
