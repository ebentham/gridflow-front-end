...
created: 2026-05-19
vendor: entsog
dataset: aggregated_physical_flows
drift_category: Referential
verifier_finding_id: vault-curl-schema-validation.md L227-228
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L227-228
tags: [drift]
---

# ENTSO-G · aggregated_physical_flows: No importable Pydantic schema (`manual_transformer_schema`)
