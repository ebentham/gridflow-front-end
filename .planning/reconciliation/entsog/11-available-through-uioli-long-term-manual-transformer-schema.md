...
verifier_finding_id: vault-curl-schema-validation.md L235-236
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L235-236
tags: [drift]
---

# ENTSO-G · available_through_uioli_long_term: No importable Pydantic schema (`manual_transformer_schema`)
