...
verifier_finding_id: vault-curl-schema-validation.md L233-234
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L233-234
tags: [drift]
---

# ENTSO-G · available_through_surrender: No importable Pydantic schema (`manual_transformer_schema`)
