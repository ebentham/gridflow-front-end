...
verifier_finding_id: vault-curl-schema-validation.md L283-284
references:
  - DRIFT-SURFACES.md § 4.3
  - vault-curl-schema-validation.md L283-284
tags: [drift]
---

# ENTSO-G · tariffs: No importable Pydantic schema (`manual_transformer_schema`)
